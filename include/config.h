...
#define YARA_TO_CROWN_ACTIVATION_DELAY 2000
...
#define SHOW_HEARTBEAT_SYNC_DELAY (YARA_TO_CROWN_ACTIVATION_DELAY + CROWN_SYNC_DELAY)
...
enum EffectId : uint8_t {
    ...
    EFFECT_PARTY_PULSE = 22,
    EFFECT_POMPON_SPARKLE = 23,
    EFFECT_PUBLIC_WAVE = 24,
    EFFECT_FINAL_RAVE = 25,
    EFFECT_FINAL_FREEZE = 26
};
